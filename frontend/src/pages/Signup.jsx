...
import { User, Mail, Lock, Cpu, AlertCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-md w-full bg-[#0D0D0E] border border-[#222226] rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs text-slate-400 font-medium">
            Join ProfileIQ AI to build your Developer Profile & match Resumes
          </p>
        </div>
        ...
        <div className="mt-8 text-center text-xs font-semibold text-slate-400 border-t border-[#222226] pt-6">
          ...
          <Link to="/login" className="text-cyan-400 hover:text-cyan-300 font-extrabold transition-colors">
            Sign in now
          </Link>
        </div>
      </div>
